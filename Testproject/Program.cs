...
namespace Testproject
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //A_M_Lookup_Hedar_Abstraction ma = new A_M_Lookup_Hedar_Abstraction();
            //List<A_M_Lookup_Hedar_Model> _List=ma.GetDataList();

            //A_M_Lookup_Line_Abstraction ma = new A_M_Lookup_Line_Abstraction();
            //List<A_M_Lookup_Line_Model> _List=ma.GetDataList();

            //M_Client_Registration_Abstraction ma = new M_Client_Registration_Abstraction();
            //List<M_Client_Registration_Model> _List=ma.GetDataList();

            //  M_Department_Information_Abstraction ma = new M_Department_Information_Abstraction();
            //List<M_Department_Information_Model> _List=ma.GetDataList();


            ////////////////////////////////////////////////////////////////////////////////////////////////////////////

            // SaveOrUpdateWithEntityFramework()  //Test EntityFrameWork Method
            ...
            //GetDataListWithEntityFramework() // Test EntityFrameWork List Method
